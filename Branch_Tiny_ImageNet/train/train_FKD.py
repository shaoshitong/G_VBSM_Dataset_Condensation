...
def get_args():
    parser = argparse.ArgumentParser("FKD Training on Tiny-ImageNet")
    ...
    parser.add_argument('--val-dir', type=str,
                        default='/path/to/tiny-iamgenet', help='path to validation dataset')
    ...
    parser.add_argument('--weight-decay', type=float,
                        default=1e-3, help='sgd weight decay')  # 1e-4 in ResNet18, 1e-3 in [ResNet50, ResNet101]
...
def main():
    ...
    train_dataset = ImageFolder_FKD_MIX(
        ...
        transform=ComposeWithCoords(transforms=[
            RandomResizedCropWithCoords(size=64,
                                        scale=(0.08, 1),
